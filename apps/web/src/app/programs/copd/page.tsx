...
const copdData = {
  ...
  description:
    "Chronic Obstructive Pulmonary Disease (COPD) is manageable with the right daily support. Our remote monitoring program delivers clinical-grade oversight directly to your home — so your care team can detect changes in your breathing before they become emergencies.",
  ...
  qualifyingConditions: [
    ...
    "Medicare or Medicaid insurance coverage (primary or supplemental)",
