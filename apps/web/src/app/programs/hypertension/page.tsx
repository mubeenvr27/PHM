...
const data = {
  ...
  qualifyingConditions: [
    "Diagnosed with Stage 1 or Stage 2 hypertension (blood pressure ≥ 130/80 mmHg)",
  ...
  steps: [
    "Your physician or our intake team submits a brief referral — fully completed in under 5 minutes.",
