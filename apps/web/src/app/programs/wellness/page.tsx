...
export const metadata: Metadata = {
  title: "Wellness Program — Mental, Nutrition & Weight Management",
  description:
...
const data = {
  programName: "Wellness: Mental, Nutrition & Weight",
  description:
  ...
  qualifyingConditions: [
    "BMI ≥ 30, or BMI ≥ 27 with one or more weight-related comorbidities (e.g., Type 2 diabetes, hypertension)",
