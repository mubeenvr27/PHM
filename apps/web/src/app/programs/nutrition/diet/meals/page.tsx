...
const data = {
  ...
  qualifyingConditions: [
    "Managing a chronic condition with dietary restrictions (e.g., low-sodium for heart failure, carb-controlled for diabetes, renal diet for CKD)",
    ...
    "Located in a CookUnity-serviced ZIP code (coverage across most major U.S. metropolitan areas)",
  ],
  steps: [
    "Your care coordinator or physician identifies the appropriate meal plan type (cardiac, diabetic, renal, general wellness) based on your diagnosis.",
    "You select your weekly meal preferences on the CookUnity platform — fresh, chef-cooked options with full nutritional labels.",
