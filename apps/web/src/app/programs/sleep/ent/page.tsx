...
export const metadata: Metadata = {
  title: "ENT Sleep Program — Surgical Pre & Post-Op Monitoring",
  description:
...
const data = {
  ...
  qualifyingConditions: [
    "Scheduled for adenotonsillectomy, uvulopalatopharyngoplasty (UPPP), or other upper-airway surgical procedures",
  ...
  steps: [
    ...
    "We ship a home sleep test device within 48 hours; completed results are returned to the surgeon before the procedure date.",
