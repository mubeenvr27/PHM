...
const data = {
  ...
  qualifyingConditions: [
    ...
    "No severe comorbidities requiring in lab polysomnography such as severe COPD or complex cardiac arrhythmia",
  ...
  image1: "/PHM Program pictures/ADULT_SLEEP_MONITORING _1.png",
