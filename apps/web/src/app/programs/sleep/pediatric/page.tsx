...
const data = {
  ...
  qualifyingConditions: [
    "Child between ages 2–17 with suspected sleep apnea, snoring, or witnessed pauses in breathing during sleep",
    "Referral from a pediatrician, ENT, or pulmonologist for home sleep assessment",
  ...
  steps: [
    ...
    "We ship a child-appropriate, FDA-cleared overnight monitoring device directly to the family — with a setup video guide.",
    "The recorded data is interpreted by a board-certified sleep physician within 72 hours, and a report is sent to the referring provider.",
  ],
};
